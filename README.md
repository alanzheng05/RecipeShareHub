...
- **Alan Zheng (Member 1)**  
  *Frontend – React*  
  - Built HomePage, RecipeList, and RecipeDetail components  
  - Handled UI routing and styling

- **Zack Beyer (Member 2)**  
  *Backend – Express + MongoDB*  
  - Built RESTful API routes for recipe CRUD operations  
  - Developed Recipe model and connected to MongoDB

- **Alex Crossen (Member 3)**  
  *Authentication and User Management*  
  - Implemented login/register functionality  
  - Built User model and JWT middleware
...
You can learn more in the [Create React App docs](https://facebook.github.io/create-react-app/docs/getting-started) or explore [React documentation](https://reactjs.org/).
